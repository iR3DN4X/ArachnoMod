...
class RenderBlockDisplay(
    ...
    private fun applyState(display: Display.BlockDisplay, fresh: Boolean) {
        ...
        display.setTransformationInterpolationDuration(if (fresh) 0 else 1)
        ...
        // sync layer only resends CHANGED values — a plain setTransformationInterpolationDelay(0) every tick is
    ...
    private fun spawnDisplayAtVisual(): Display.BlockDisplay {
        ...
        display.snapTo(position.x, position.y, position.z, 0f, 0f)
