...
object Config {
    ...
    val SPAWN_ANGLE_ATTEMPTS = IntValue("spawnAngleAttempts", 24, 4, 1024,
    ...
    val SPAWN_CLOSE_FALLBACK_DISTANCE = DoubleValue("spawnCloseFallbackDistance", 6.0, 0.0, 128.0,
        comment("LAST-RESORT SKYBLOCK FALLBACK. Normally the spider never spawns closer than",
